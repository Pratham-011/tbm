    ...
    <main >
      ...
      <section data-scroll-section className="mx-auto w-screen flex justify-center items-center ">
        ...
        <div className="flex justify-center items-center absolute w-screen h-screen top-0 z-[-1] gap-10 overflow-hidden ">
          <div className="h-screen w-[30vw] shrink-0  flex-col gap-10 justify-center items-end hidden md:flex"  data-scroll
                  data-scroll-speed="1" >
...
<img
      ...
      />
          ...
          <div className="h-screen md:w-[50vw] shrink-0 flex flex-col gap-10 justify-center items-center"   data-scroll
...
<img
          ...
          {/* <img
            ...
            />
             <BackgroundVideo
                    autoPlay
                    src="https://pub-7ef9cd4a2b164f838c4e056cc6eb2f6d.r2.dev/tinywow_Copy%20of%20HOME%20Ad%20film%20Video_72181837.mp4"
          ...
          <div className="h-screen w-[30vw]  shrink-0  flex-col gap-10 justify-center items-center hidden md:flex"  data-scroll
