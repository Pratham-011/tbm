...
export default function RootLayout({ children }) {
  ...
  useEffect(() => {
    ...
    .to(".loader", {
        opacity: 1,
        className: "loader active w-screen h-dvh flex items-center justify-center left-0 top-0  z-50",
        duration: 1, // Second animation state
      })
      .to(".loader", {
        delay:1,
        opacity: 1,
        className: "loader fixed w-screen h-dvh flex items-center justify-center left-0 top-0  z-50",
        duration: 1, // Second animation state
      })
      .to(".loader", {
        delay:1,
  ...
  return (
    <html lang="en">
      ...
      {/* loader start*/}
      <div className="loader fixed  w-screen h-dvh flex items-center justify-center left-0 top-0  z-50">
      <svg className="h-16 md:h-24 " viewBox="0 0 817 365" fill="none" xmlns="http://www.w3.org/2000/svg">
